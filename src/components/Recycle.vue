<template>
    <div>
        ...
        <li v-for="(showImg) in imgList" :key="showImg.img_id" >
            ...
            <div><i class="el-icon-success" @click="deleteImg(showImg.img_id)"></i>
                <i class="el-icon-error" @click="loveImg(showImg.img_id)"></i>
            </div>
        </li>
       </ul>
       <el-pagination
...
import {reqGetShowDeletePicture} from '@/api/index'
export default {
    name:'Recycle',
    data(){
        return {
